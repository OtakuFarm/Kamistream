...
export default function Home() {
  ...
  // Recently Updated — shared with /latest-episodes via useRecentlyUpdated so
  // the home row and the crawlable hub can never disagree. The server-side
  // twin crawlers see lives in api/latest.js — keep the join in sync there.
  const { data: recentlyUpdated } = useRecentlyUpdated(12);
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 space-y-8 sm:space-y-10 pb-20">
      ...
      <div id="banner-468x60" className="flex justify-center my-4 min-h-[1px] overflow-hidden"
